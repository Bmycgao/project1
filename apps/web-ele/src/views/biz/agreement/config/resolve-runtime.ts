 ...
 */
import type { PageSchemaApi } from '#/api/index';

import { getPageSchema } from '#/api/index';

import { DEFAULT_AGREE_FIELD_RULES } from '../access/field-access';
import {
...
function fromPageSchema(
  ...
  return {
    ...
    buttons,
    columns,
    statusIn: Array.isArray(schema.statusIn)
      ? schema.statusIn
      : local?.statusIn,
    fieldRules,
    modules,
