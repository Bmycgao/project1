    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            id: 70_116,
            pid: 701,
            name: 'AgreeFieldCompensatee',
            status: 1,
            type: 'button',
            authCode: 'Agree:Field:compensatee',
            meta: { title: '字段-被征收人' },
          },
          {
            id: 70_117,
            pid: 701,
            name: 'AgreeFieldCertNo',
            status: 1,
            type: 'button',
            authCode: 'Agree:Field:certNo',
            meta: { title: '字段-产权证号' },
          },
          {
            id: 70_118,
            pid: 701,
            name: 'AgreeFieldAddress',
            status: 1,
            type: 'button',
            authCode: 'Agree:Field:address',
            meta: { title: '字段-房屋地址' },
          },
          {
            id: 70_106,
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            id: 70_216,
            pid: 702,
            name: 'AgreeLawyerFieldCompensatee',
            status: 1,
            type: 'button',
            authCode: 'Agree:Field:compensatee',
            meta: { title: '字段-被征收人' },
      ...
      },
      {
        ...
        pid: 7,
        path: 'print-design',
        name: 'EAgreePrintDesign',
        authCode: 'Agree:Menu:PrintDesign',
        status: 0,
        type: 'menu',
        meta: {
        ...
        component: '/biz/agreement/print/designer/index',
      },
      {
        id: 799,
        pid: 7,
